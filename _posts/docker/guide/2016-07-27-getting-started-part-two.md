...
So, now we have images building, a working script and a working test! The next step is to move from CI to CD: [pushing images and deploying your code.]({% link docker/guide/2016-07-28-getting-started-part-three.md %})
