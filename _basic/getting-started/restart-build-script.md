...
redirect_from:
  - /integrations/api/restart-build-script
---
...
Below is the `codeship-restart-build` script that is available within Codeship to help restart a build. We've included the source here as an example of how to use the Codeship API to automatically trigger builds.
