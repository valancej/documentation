...
Take a look at our [encrypted environment files documentation]({{ site.baseurl }}{% link _docker/getting-started/encryption.md %}) and add a `heroku-deployment.env.encrypted` file to your repository. The file needs to contain an encrypted version of the following file:
