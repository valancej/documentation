...
After connecting to a repository, you will either continue with the [classic infrastructure]({{ site.baseurl }}{% link basic/index.md %}) or be able to choose between classic and [Docker infrastructure]({{ site.baseurl }}{% link pro/index.md %}) if the latter is activated on your account.
...
If you wish to skip a build, please refer to the article about skipping builds for the [classic infrastructure]({{ site.baseurl }}{% link _basic/getting-started/skipping-builds.md %}) and [Docker infrastructure]({{ site.baseurl }}{% link _pro/getting-started/skipping-builds.md %}).
