...
or other necessary variables in the [environment configuration]({{ site.baseurl }}{% link _classic/getting-started/set-environment-variables.md %}). You can run your tests exactly the same
